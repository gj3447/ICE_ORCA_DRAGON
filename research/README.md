...
| [`benchmarks/`](benchmarks) | source-pinned design-only comparator DAG and read-only external-bridge audit; neither supplies canonical evidence or execution authority |
