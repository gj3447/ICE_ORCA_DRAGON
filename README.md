...
[![Runnable kernels](https://img.shields.io/badge/Runnable_kernels-48-3776ab?style=for-the-badge&logo=python&logoColor=white)](#run-a-kernel)
...
The current CLI exposes **48 runnable Python kernels**. `./ice list --json` is the authority for the
...
| CPT × Temporal-Folded SUSY | `phase11_collar_admissibility`, `phase12_boundary_twist_interface`, `phase13a_lorentzian_branch_supercharge`, `phase14a_chiral_clock_charge_first`, `phase15r_parent_sign_reproduction`, `phase16_bgg_single_source`, `phase17_time_line_fold_algebra` |
