...
14. Stop at `open:gate1-phase-locked-fiber-to-source-derived-joint-cycle`: charts on other components,
   a global atlas, normalized quantum endpoint states, ghost/BFV replacement measure, the
