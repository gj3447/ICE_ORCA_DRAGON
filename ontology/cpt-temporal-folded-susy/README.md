...
15. Stop at `open:gate1-phase-locked-fiber-to-source-derived-joint-cycle`: ordering, self-adjoint
   domains, edge conditions, a corrected full symbol, global normalization and Maslov gluing, charts
   on other components, a global atlas, coordinate-polarization endpoints, ghost/BFV replacement measure, the
