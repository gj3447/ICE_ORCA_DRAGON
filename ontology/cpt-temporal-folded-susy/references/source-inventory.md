...
| Bounded P1/P4/P2/P6/P7 bridge snapshots (2026-08-31) | Weyl (1910) and Eckhardt et al. for singular-Weyl scope; Teitelboim/Hojman--Kuchař--Teitelboim for the HDA boundary; Kamenshchik--Lyakhovich and Cattaneo--Mnev--Reshetikhin for BFV/BV--BFV framing; CLASS/Cobaya for downstream likelihood machinery | The repository records only an admission denial, a finite nonreal proxy, complex-scalar SU(2) golden coefficients plus a discarded projection remainder, and a finite endpoint-gluing toy with an unselected lapse cycle. These sources neither turn the remainder into HDA/an anomaly nor supply an absolute gravity measure, common physical product, primordial spectrum, or likelihood. |
