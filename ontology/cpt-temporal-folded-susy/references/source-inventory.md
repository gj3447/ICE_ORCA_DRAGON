...
| `source:henneaux-teitelboim-vergara-1992` — M. Henneaux, C. Teitelboim, J. D. Vergara, [*Gauge invariance for generally covariant systems*](https://doi.org/10.1016/0550-3213(92)90166-9), Nucl. Phys. B 387 (1992) 391–418 | `CITES`-only canonical-gauge reference for transversality, gauge-related endpoint states, improved boundary actions, and componentwise orientation | Does not prove that this repository's improved-static or time-dependent trace-gauge replacement exists globally, choose its endpoint states, or supply its BFV measure |
| `source:marolf-1996-minisuperspace-path-integrals` — D. Marolf, [*Path integrals and instantons in quantum gravity: Minisuperspace models*](https://doi.org/10.1103/PhysRevD.53.6979), Phys. Rev. D 53 (1996) 6979–6990 | `CITES`-only full-real-lapse and gauge-fixed minisuperspace path-integral reference for the trace-gauge boundary | Its model-specific modulus coordinate gauge is not a general signed-versus-absolute determinant theorem for this momentum gauge and does not derive the repository's local root ledger or replacement source |
...
| `source:banihashemi-jacobson-2025` — B. Banihashemi, T. Jacobson, [*On the lapse contour in the gravitational path integral*](https://doi.org/10.1103/PhysRevD.111.066014), Phys. Rev. D 111 (2025) 066014 | `CITES`-only contour result for its stated momentum-integration order | Does not fix the Phase 27–28 FP endpoint factor, determinant, or (n_\sigma) |
...
| Non-numbered Gate-1 straight-lift, phase-band, scalar-source, finite bosonic canonical, and trace-gauge controls | Witten (2010); Banihashemi–Jacobson; Gibbons–Hawking–Perry; Henneaux–Teitelboim–Vergara; Marolf (1996); Halliwell (1988); Rogers | Witten supplies only relative-cycle/good-end framing. Banihashemi–Jacobson supplies the local trace-gauge/FP premise before a lower-lateral momentum-first treatment, not a global slicing theorem or this finite source. Henneaux–Teitelboim–Vergara bounds endpoint transversality and improved actions; Marolf and Halliwell bound gauge-fixed/full-lapse minisuperspace readings; Rogers separates local FP nonvanishing from global BFV/Gribov admissibility. Gibbons–Hawking–Perry frames the conformal-sign obstruction. Repository evidence supplies the exact bad subsequence, affine class, scalar-source link, opposite-sign bosonic convergence obstruction, homogeneous trace canonical pair, FP horizon \(a^2V=2\), local reduction and lower-lateral scalar Gaussian. It contradicts only the shortcut that appends a static trace delta/FP factor to the unchanged constant-lapse fixed-\(a\) \(m=2\) source. A separately rederived improved-static or time-dependent gauge, endpoint action/states, full BFV measure, source deformation, zero lapse, physical original joint cycle, global coefficient, physics and TOE all remain open or null. |
...
source. The improved-static and time-dependent replacement routes, endpoint states, BFV measure,
source deformation, original cycle, global coefficient, physics, and TOE remain open or null.
