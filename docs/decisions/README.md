...
- [`ICE_RESEARCH_MCP_SKILL_INTEGRATION_2026-09-01.md`](ICE_RESEARCH_MCP_SKILL_INTEGRATION_2026-09-01.md) adds a local read-only MCP v2 surface and a Codex research skill for bounded graph context and OpenAlex source discovery; neither is an autonomous research loop or scientific ratifier.
